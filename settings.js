...
module.exports = VAJIRA-MD=DAVSwLqA#tJXHbTJDw-T8MQeu3ODoU8XYZBPuqN2uCVEENPERB4c
SESSION_ID: process.env.SESSION_ID === undefined ? '' : 
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? ''+258868754545 : process.env.OWNER_NUMBER,   
...
HEROKU_APP_NAME: process.env.HEROKU_APP_NAME === undefined ? ''Alex service : process.env.HEROKU_APP_NAME,         
